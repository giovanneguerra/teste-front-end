...
var app, base, concat, directory, gulp, gutil, hostname, path, refresh, sass, uglify, imagemin, minifyCSS, del, browserSync, autoprefixer, gulpSequence, shell, sourceMaps, plumber, browserify, source;
...
gulp.task('default', ['browserSync', 'scripts', 'styles', 'browserify'], function() {
